...
from .views import CustomLoginView, AduanViewSet,  UserViewSet, PeminjamanBarangViewSet, BarangViewSet, dashboard_aduan, update_status_aduan, dashboard_barang, delete_barang, edit_barang, dashboard_user, delete_user, edit_user, dashboard_peminjaman_barang, update_status_peminjaman, update_status_dikembalikan, delete_peminjaman_barang, detect_qr_code, user_detail, update_status_absensi
